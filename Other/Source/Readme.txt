...
user in an INI file next to ShotcutPortable.exe called ShotcutPortable.ini.
...
copy AppNamePortable.ini from this directory to ShotcutPortable.ini next to
ShotcutPortable.exe. The options in the INI file are as follows:
